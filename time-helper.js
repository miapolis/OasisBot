module.exports.getFormattedMilitaryTime = () => {
    ...
    const time = `${today.getHours() - 6}:${minutes.length === 1 ? '0' + minutes : minutes} - ${seconds.length === 1 ? '0' + seconds : seconds}s`
    return time
}
...
module.exports.getFormattedMilitaryTimeMill = () => {
    ...
    const time = `${today.getHours() - 6}:${minutes.length === 1 ? '0' + minutes : minutes} - ${seconds.length === 1 ? '0' + seconds : seconds}.${milliseconds}s`
    return time
}